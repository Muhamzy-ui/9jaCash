...
async function initDb() {
  ...
  try {
    ...
    const alterStatements = [
      ...
      "ALTER TABLE junior_admins ADD COLUMN IF NOT EXISTS community_link TEXT",
      "ALTER TABLE junior_admins ADD COLUMN IF NOT EXISTS community_active INTEGER DEFAULT 1",
      "ALTER TABLE junior_admins ADD COLUMN IF NOT EXISTS whatsapp_community_link TEXT",
      "ALTER TABLE junior_admins ADD COLUMN IF NOT EXISTS whatsapp_community_active INTEGER DEFAULT 1",
