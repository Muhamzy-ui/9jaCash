...
// GET /api/admin/junior/users — Fetch referred users
app.get('/api/admin/junior/users', async (req, res) => {
  ...
  try {
    const list = await db.query(`
      SELECT phone, email, full_name, bank_name, account_number, balance, mining_power, plan_name, status, created_at 
      FROM users 
...
// POST /api/receipts/update-status — Approve or decline receipt
